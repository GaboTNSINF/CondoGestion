...
urlpatterns = [
    ...
    path('portal/', views.portal_residente_view, name='portal_residente'),
    path('avisos/', views.avisos_list_view, name='avisos_list'), # New
    path('soporte/', views.soporte_view, name='soporte'), # New
